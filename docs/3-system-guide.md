> **Mirror** of `skills/infra-platform-core/references/system-guide.md` at release 1.3 — the canonical copy ships with the core skill and is what help mode reads. Edit there; refresh mirrors at each release (system-maintenance step).
